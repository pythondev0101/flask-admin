...
var barData = {
    ...
    datasets: [{
        ...
        highlightStroke: WingoAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: WingoAdminConfig.secondary ,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: WingoAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: WingoAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        value: 120,
        color: WingoAdminConfig.secondary ,
        highlight: WingoAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: WingoAdminConfig.primary ,
        pointColor: WingoAdminConfig.primary ,
        ...
        strokeColor: WingoAdminConfig.secondary ,
        pointColor: WingoAdminConfig.secondary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: WingoAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: WingoAdminConfig.primary,
        pointColor: WingoAdminConfig.primary,
        pointStrokeColor: WingoAdminConfig.primary,
        pointHighlightFill: WingoAdminConfig.primary ,
