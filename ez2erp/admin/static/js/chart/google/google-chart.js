...
function drawBasic() {
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#a927f9"  , WingoAdminConfig.secondary , WingoAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: ["#f8d62b", "#a927f9" , "#51bb25", WingoAdminConfig.secondary , WingoAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", WingoAdminConfig.primary , WingoAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b","#dc3545", WingoAdminConfig.primary , "#f8d62b", "#51bb25", WingoAdminConfig.primary , WingoAdminConfig.secondary ,"#51bb25", WingoAdminConfig.primary , "#a927f9", "#f8d62b", WingoAdminConfig.primary , WingoAdminConfig.primary, "#a927f9", WingoAdminConfig.secondary , WingoAdminConfig.primary , "#51bb25"]
        };
                ...
                palette: [
                    {
                        ...
                        "dark": WingoAdminConfig.secondary ,
                        "light": "#047afb"
                    }
                ]
