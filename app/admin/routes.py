...
def admin_index(*model, fields, url, action="", modal="",modal_id="",edit_url="",template="admin/admin_index.html"):
    ...
    return render_template(template, context=context,
                           ...
                           title=title,action=action,modal=modal,modal_id=modal_id,edit_url=edit_url)
